...
| [`ST_CoverageClean`](#st_coverageclean)                         | Remove the gaps between polygon edges that should be an exact match but aren't due to the coordinate data itself.                                                                                                                                                                                                                                                     |
...
Aligns the edges of a polygon list whose edges are meant to align but are in fact not exact matches.
