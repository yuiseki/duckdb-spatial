...
public:
	virtual ~WKBSizeCalculator() = default;
...
const_data_ptr_t WKBWriter::Write(const string_t &geometry, uint32_t *size, ArenaAllocator &allocator) {
	const geometry_t geom(geometry);
